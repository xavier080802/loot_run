...
/******************************************************************************/
/*!
\fn         void AEInputMouseWheelDelta(s32* pDelta)

\brief      Get the distance scrolled by the mouse wheel since the last update.

\param      [out] pDelta
            Positive value indicates the distance scrolled away from the user.
            Negative value indicates the distance scrolled towards the user.
            Zero value indicates no change in mouse scroll.
